...
class CategoryProduct extends Controller
{
    ...
    public function show_category_home(Request $request ,$slug_category_product){
        ...
        $category_product_desc = null;
        $category_product_keywords = null;
        $category_product_title = null;
        $url_canonical = $request->url();
        
        if (count($category_by_id) == 0){
            foreach($category_by_id as $key => $val){
                //seo
                $category_product_desc = $val->category_desc;
                $category_product_keywords = $val->category_product_keywords;
                $category_product_title = $val->category_name;
                $url_canonical = $request->url();
                //--seo
            }
        }
        ...
        ->with('category_name',$category_name)->with('category_product_desc',$category_product_desc)
        ->with('category_product_keywords',$category_product_keywords)->with('category_product_title',$category_product_title)
